        ...
        <div className='container'>
            ...
            <div className='grid md:grid-cols-3 sm:grid-cols-1 gap-3 py-5'>
                ...
                data-aos-duration="2000"
                 style={{ backgroundColor: '#1F33D8' }} className="rounded-lg p-2">
                    <div className="p-3">
                        <h2 className="text-white text-center flex justify-center items-center gap-2 text-2xl p-3"><AiOutlineAntDesign />AkaWallet</h2>
                        ...
                        <div className="">
                            <button className="text-white flex justify-center items-center gap-2">Choose Wallet<AiOutlineArrowRight /></button>
                        </div>
                    </div>
                </div>
                {/* ------------------ */}
                ...
                data-aos-easing="ease-out-cubic"
                data-aos-duration="2000"
                 style={{ backgroundColor: '#FFD456' }} className="rounded-lg p-2">
                    <div className="p-3">
                        <h2 className=" text-neutral text-center flex justify-center items-center gap-2 text-2xl p-3"><AiOutlineAntDesign /> AkaSafe</h2>
                ...
                style={{ backgroundColor: '#1F33D8' }} className="rounded-lg p-2">
                    <div className="p-3">
                        <h2 className="text-white text-center flex justify-center items-center gap-2 text-2xl p-3"><AiOutlineAntDesign /> AkaMask</h2>
